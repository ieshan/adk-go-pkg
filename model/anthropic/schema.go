...
// schemaToJSONSchema is adapted from model/openai/schema.go. It is format-
// agnostic and converts genai.Schema into the JSON Schema maps required by
// Anthropic's input_schema and structured-output json_schema fields.
